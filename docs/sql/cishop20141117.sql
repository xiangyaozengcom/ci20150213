...
#插入一条记录作为管理员
insert into cishop_admin(admin_name,password,email) values('admin','21232f297a57a5a743894a0e4a801fc3','admin@itcast.cn');
insert into cishop_admin(admin_name,password,email) values('admin','admin','admin@itcast.cn');
